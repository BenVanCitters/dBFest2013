...
public class SkeletonWrapper : MonoBehaviour {
	...
	public bool DisplayTrackingStates = false;
	...
	private void OnGUI()
	{
		if(DisplayTrackingStates)
		{
			for (int ii = 0; ii < Kinect.Constants.NuiSkeletonCount; ii++)
			{
				GUI.Label(new Rect(0, ii * 30, 200, 30),"player["+ii+"]: " + players[ii]);	
			}
		}
	}
	...
	private void processSkeleton () {
		...
		Debug.Log("trackedcount: " + trackedCount);
